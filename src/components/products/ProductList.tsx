...
import { selectProduct, selectSearchValue } from "@/redux/products/selectors";
        ...
        return (
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2">
              <Link
                to={`/${categoryNames[el.category]}/${el.id}`}
                className="flex items-center justify-center bg-[#B0907A] hover:bg-[#9b7e6c] text-mainBgColor w-full rounded-[14px] hover:bg-opacity-90 sm:hover:scale-100 hover:scale-105 hover:shadow-lg transition-transform duration-300"
              >
              ...
              <button
                className="mt-auto sm:px-[20px] w-full sm:w-auto flex items-center justify-center bg-secondareBgColor text-mainBgColor py-2 rounded-[14px] hover:bg-opacity-90 sm:hover:scale-100 hover:scale-105 hover:shadow-lg transition-transform duration-300"
                onClick={() => {
                  setActiveFirst(0);
                  setActiveSecond(0);
